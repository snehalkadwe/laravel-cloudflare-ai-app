<div>
    ...
    <div class="grid grid-cols-2 gap-1">
        <div class="h-screen p-10">
            <div class="border border-pink-700 h-full">
                <h1 class="text-center italic font-bold m-4">Text generated from an image</h1>
                @if (session()->get('text'))
                <h2>Sentiment analysis of text generated by an image</h2>
                <p class="text-justify p-6">{{ session()->get('text') }}</p>
                                ...
                                <label
                                    ...
                                    <div
                                        ...
                                        <p class="pointer-none text-gray-500 "><span class="text-sm">Drag and
                                                drop</span> files
                                            here
                                            <br /> or <a href="" id="" class="text-blue-600 hover:underline">select a
                                                file</a>
                                            from
                                            your computer
                                        </p>
